...
SECRET_KEY = env_vars.get("SECRET_KEY", "mt6236o#!qk^16oamee7_fcfji&gcz-8_yz^ux77wgo-ccr2%_")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = env_vars.get("DEBUG", "1") == "1"

ALLOWED_HOSTS = [".kinescope.systems", "localhost", "host.docker.internal"]
CSRF_TRUSTED_ORIGINS = [
    "https://*.kinescope.systems",
]

AWS_ACCESS_KEY_ID = env_vars.get("AWS_ACCESS_KEY_ID")
AWS_SECRET_ACCESS_KEY = env_vars.get("AWS_SECRET_ACCESS_KEY")
AWS_REGION_NAME = "ap-south-1"
AWS_S3_BUCKET_NAME = "private.kinescope.systems"
CDN_FOLDER_PREFIX = "medscan/uploads/"
...
CELERY_BROKER_URL = env_vars.get("CELERY_BROKER_URL", "redis://localhost:6379")
CELERY_ACCEPT_CONTENT = ["application/json"]
CELERY_TASK_SERIALIZER = "json"
CELERY_RESULT_SERIALIZER = "json"
CELERY_TASK_DEFAULT_QUEUE = env_vars.get("DEFAULT_QUEUE", "development")
